...
<div align="center">
  ...
  <a href="https://github.com/crisxuan?tab=followers">
    <img src="https://img.shields.io/github/followers/crisxuan?style=for-the-badge&label=Followers&labelColor=111827&color=f59e0b" alt="GitHub followers" />
  </a>
</div>
...
<div align="center">
  <a href="https://github.com/crisxuan">中文</a>
  <span> / </span>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p>A workflow for searching, scoring, reviewing, and recommending open-source projects worth following.</p>
      <p><sub>Private prototype · polishing before public release</sub></p>
    </td>
    <td width="50%">
      <h3>Content Production Pipeline</h3>
      <p>A system that connects material collection, LLM-assisted writing, format adaptation, and multi-platform publishing.</p>
  ...
  <tr>
    <td width="50%">
      ...
      <p>A Chinese content formatting workbench that turns Markdown and HTML into structured layouts for publishing platforms.</p>
      <p><sub>Private prototype · design and compatibility first</sub></p>
    </td>
    <td width="50%">
      <h3>Local Data Analysis Desktop Tool</h3>
      <p>A local-first experience for personal data, search, visualization, and AI-assisted Q&A.</p>
...
<div align="center">
  <sub>Building useful AI-native tools, one workflow at a time.</sub>
</div>
